...
# %% Selector:
def plate_selector(plate_amount, plate_numbers, extract_folder, csv_folder):
    """
...
def main(working_path, plate_amount, plate_numbers):
    ...
    merge_path = path.join(working_path, "metadata")

    ftp, plate_list, download_list = plate_selector(plate_amount, plate_numbers, extract_path, merge_path)
